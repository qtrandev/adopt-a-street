...
$(function() {
  var center = new google.maps.LatLng(26.120141, -80.213279);
  var mapOptions = {
    center: center,
  ...
  // Add Fort Lauderdale roads Fusion Table
  layer = new google.maps.FusionTablesLayer({
    query: {
      select: '\'Geocodable address\'',
      from: '1Sw0QIVHmh2Kg1NEZupt7uiQ7Pbxl5PU5uKHUiEc5'
    }
  });
  layer.setMap(map);
  ...
  var greenMarkerImage = new google.maps.MarkerImage('/assets/markers/green-a81c1ecee14d4f817f5cee7a6fe16c10.png',
    size,
    origin,
    anchor
  );
  var redMarkerImage = new google.maps.MarkerImage('/assets/markers/red-3505b842a2839663c7e3b097dc20ebd7.png',
    size,
    origin,
    anchor
  );
  var markerShadowImage = new google.maps.MarkerImage('/assets/markers/shadow-4bb7e0b7e461598aaf343d9558454db3.png',
      ...
      success: function(data) {
        $.ajax({
          ...
          data: {
            ...
            'flash': {
              'notice': "You just adopted a hydrant!"
            }
          },
          success: function(data) {
            activeInfoWindow.close();
